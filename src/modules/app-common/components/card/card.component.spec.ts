...
describe('CardComponent', () => {
    ...
    it('should push headerActions', () => {
        ...
        fixture.detectChanges();
        expect(component.cardClasses.push).toHaveBeenCalledWith('sb-card-header-actions');
    });
    ...
    it('should push scrollable', () => {
        ...
        spyOn(component.cardClasses, 'push').and.callThrough();
        fixture.detectChanges();
        expect(component.cardClasses.push).toHaveBeenCalledWith('sb-card-scrollable');
    });
});
