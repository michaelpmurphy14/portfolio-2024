...
@Component({
    template: `
        <sbpro-press [someInput]="someInput" (someFunction)="someFunction($event)"></sbpro-press>
    `,
})
...
describe('PressComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, PressComponent],
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('sbpro-press')).toEqual(jasmine.anything());
    });
});
